...
const Pricing12_IO9K8YUO = () => {
	return (
		<section className="ezy__pricing12_IO9K8YUO py-14 md:py-24 bg-white dark:bg-[#0b1727] text-zinc-900 dark:text-white relative overflow-hidden z-[1]">
			<div
...
export default Pricing12_IO9K8YUO;
